...
// ⚡ Bolt Optimization: Use a simple regex for word counting instead of a heavy NLP
// library like `reading-time-estimator` to avoid significant CPU and GC bottlenecks
// during build and feed generation across many files.
function getReadingMinutes(text: string): number {
