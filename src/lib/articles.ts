        ...
        candidates.map(async ({ groupPath, name }): Promise<Article | null> => {
          ...
          try {
            ...
            return {
              ...
              // Performance optimization: Using a simple regex word count instead
              // of the heavy NLP library (reading-time-estimator) speeds up build
              // and feed generation significantly.
