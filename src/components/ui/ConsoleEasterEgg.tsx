...
export function ConsoleEasterEgg() {
    ...
    useEffect(() => {
        ...
        const hintStyle = 'color: #8be9fd; font-style: italic; font-size: 11px; margin-top: 4px;';
        ...
        (window as any).surpriseMe = () => {
            if (isPlaying.current) return "Already purring! 🐾";
        ...
        return () => {
            ...
            delete (window as any).surpriseMe;
            delete (window as any)._stopSurprise;
        };
    }, []);
