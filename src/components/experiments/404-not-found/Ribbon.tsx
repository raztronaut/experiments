...
const EMPTY_TEXTURE = new THREE.DataTexture(DATA_ONE_PIXEL, 1, 1, THREE.RGBAFormat);
...
const Ribbon = function Ribbon({
    ...
    const texture = useCachedTexture(frontTextureKey, () => generateFrontTexture({
        text,
        subscript,
    ...
    const generatedBackTexture = useCachedTexture(backTextureKey || "", () => generateBackTexture({
        text: backsideText,
        color,
        width: width,
        height: height,
