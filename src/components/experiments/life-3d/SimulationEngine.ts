...
export class SimulationEngine {
    ...
    constructor(width: number, height: number, depth: number, rules?: Life3dRules) {
        this.width = width;
        this.height = height;
        this.depth = depth;
    ...
    public seed(density: number = 0.1) {
            ...
            for (let y = 0; y < this.height; y++) {
                for (let x = 0; x < this.width; x++) {
                    ...
                    if (willBeAlive) {
                        ...
                        this.ages[currentIdx] = isAlive ? Math.min(this.ages[currentIdx] + 1, 65535) : 1;
                    } else {
    ...
    public getIntensities(): FloatGrid { return this.intensities; }
    public getAges(): Uint16Array { return this.ages; }
