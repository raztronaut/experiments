...
<ImageSwitcher>
  <img
    alt="Replay operations center with multiple live sports feeds across a curved wall"
    src="/experiments/basketball-replay-center/article/control-center-reference-2.png"
  />
  <img
    alt="Blue control center with operators facing a large live systems board"
    src="/experiments/basketball-replay-center/article/control-center-reference-1.png"
  />
  <img
    alt="NBA draft-style command center with wall displays and interactive table"
    src="/experiments/basketball-replay-center/article/nba-command-center.webp"
  />
</ImageSwitcher>
