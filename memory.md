...
- `CollectedPreview` component (`src/components/registry/CollectedPreview.tsx`) mirrors `ExperimentPreview` but points iframes to `/collected/<slug>` instead of `/experiments/<slug>`
