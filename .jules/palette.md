...
**Learning:** When creating dynamically generated Table of Contents or similar navigation buttons that rely on scroll interactions rather than standard anchor links, screen readers need explicit indicators of the current active section.
**Action:** Always apply `aria-current="true"` conditionally to indicate the active section to screen readers, explicitly define `type="button"`, and combine with accessible focus rings (`focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring`).
