...
## 2024-05-12 - Scroll-based navigation accessibility
**Learning:** When dynamically generating Table of Contents or similar navigation buttons that rely on scroll interactions rather than standard anchor links, screen readers may not automatically know which section is active or when focus changes.
